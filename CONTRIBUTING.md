...
Ready to contribute? Here's how to set up `latlonghelper` for local development.

1. Download a copy of `latlonghelper` locally.

2. Create and activate a conda environment for `latlonghelper`:

    ```console
    $ conda create -n latlonghelper python=3.12
...
Please note that the `latlonghelper` project is released with a
